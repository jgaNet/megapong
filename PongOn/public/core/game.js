define(["jquery"], function($){ return Game; });
	...
	Game.prototype.gameplay = function (){
		...
		/*MOUVEMENTS*/
		if (this.player1.up == true){ this.player1.posY-=2; }
		if (this.player1.down == true){ this.player1.posY+=2; }
		if (this.player2.up == true){ this.player2.posY-=2; }
		if (this.player2.down == true){ this.player2.posY+=2; }
	...
	Game.prototype.setLoop = function (){
		/*Debug*/ console.log("1. new Game setLoop");
		/* compatibilité */
	...
	Game.prototype.runLoop = function (){
		...
		var that = this; // pour éviter probleme scope
